...
Test: Execute the $push update script on a test document. Verify that the logs property is an instance of an array (Array.isArray()) and that its length (length) increases exactly by 1 after the operation.
